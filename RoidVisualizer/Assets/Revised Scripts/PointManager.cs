...
public class PointManager : MonoBehaviour
{
            ...
            { //It's a volume
                ...
                if (float.TryParse(substrings[2], out size) && showTerritory)
                {
                    ...
                    switch (substrings[1])
                    {
                        ...
                        case "Planet": //Planet
                            CreateVolume(point.unityPosition, size + 20, planetMarkerPrefab);//Add 20 to height to offset mountains
                            break;
    ...
    void CreateVolume(Vector3 position, float scale, GameObject prefab) //Territories, planets, etc.
    {
